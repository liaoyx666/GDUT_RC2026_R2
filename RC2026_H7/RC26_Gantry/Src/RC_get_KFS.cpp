...
namespace gantry
{
	...
	GetKFS::GetKFS(gantry::Gantry& gantry_ , gantry::Suction& suction_, mini_laser::MiniLaser& laser_)
		  ...
		  gantry_event
		{
				...
				path::Event3(25, 0.04f, true, true)//pick
		  },
		  suction_(suction_),
		  laser_(laser_),
...
// ============================================================
		...
		void GetKFS::Set_Ctrl_Mode(SpeedMode mode_)
	{
		...
		switch (mode_)
		{
			case SpeedMode::SLOW:   scale = 0.4f; break;
		...
		user.Set_Y_Td(2000.f * scale, 8000.f * scale);
		user.Set_Z_Td(2000.f * scale, 8000.f * scale);
		user.Set_P_Td(26.f   * scale, 14.f    * scale);
	}
        ...
        case ARM_TASK::PICK_UP_KFS_40CM_1_step2:
            switch (seq_idx)
            {
                ...
                case 2: Set_Ctrl_Mode(SpeedMode::SLOW);   Set_Step_Delay(0);    		  Set_Step_Target(0.20f, 0.00f, 0.39f, 1.57f, CtrlMode::OPEN_LOOP);        Set_Step_Act(1); return true;
				 case 3: Set_Ctrl_Mode(SpeedMode::NORMAL);   Set_Step_Delay(0);    		  Set_Step_Target(0.20f, 0.00f, 0.39f, 1.57f, CtrlMode::Check);        Set_Step_Act(1); return true;
