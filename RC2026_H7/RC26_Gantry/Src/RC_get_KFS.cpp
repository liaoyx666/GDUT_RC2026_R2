    ...
    switch (cur_task)
    {
        ...
        case ARM_TASK::PICK_UP_KFS_20CM_1_step2:
            switch (seq_idx)
            {
                ...
                case 1: Set_Ctrl_Mode(SpeedMode::NORMAL); Set_Step_Delay(300000);   		  Set_Step_Target(0.48f, 0.00f, 0.16f, 3.14f, CtrlMode::OPEN_LOOP);        Set_Step_Act(1); return true;
				...
				case 3: Set_Ctrl_Mode(SpeedMode::SLOW); Set_Step_Delay(0);          		Set_Step_Target(0.2f,  0.00f, 0.16f, 1.57f, CtrlMode::Check);        Set_Step_Act(1); return true;
        ...
        case ARM_TASK::PICK_UP_KFS_20CM_2_step2:
            switch (seq_idx)
            {
				...
				case 3: Set_Ctrl_Mode(SpeedMode::SLOW); Set_Step_Delay(0);         	  Set_Step_Target(0.2f,  0.00f, 0.40f, 1.57f, CtrlMode::Check);        Set_Step_Act(1); return true;
        ...
        case ARM_TASK::PICK_UP_KFS_40CM_1_step2:
            switch (seq_idx)
            {
                ...
                case 2: Set_Ctrl_Mode(SpeedMode::SLOW);   Set_Step_Delay(0);    		  Set_Step_Target(0.20f, 0.00f, 0.39f, 1.57f, CtrlMode::OPEN_LOOP);        Set_Step_Act(1); return true;
				 case 3: Set_Ctrl_Mode(SpeedMode::SLOW);   Set_Step_Delay(0);    		  Set_Step_Target(0.20f, 0.00f, 0.39f, 1.57f, CtrlMode::Check);        Set_Step_Act(1); return true;
                ...
                case 5: Set_Ctrl_Mode(SpeedMode::SLOW);   Set_Step_Delay(0);          Set_Step_Target(0.20f,  0.00f, 0.39f, 1.57f, CtrlMode::Y_LOCK);           Set_Step_Act(1); return true;
        ...
        case ARM_TASK::PICK_DOWN_KFS_1_step1:
            switch (seq_idx)
            {
                ...
                case 1: Set_Ctrl_Mode(SpeedMode::FAST);   Set_Step_Delay(10000);      Set_Step_Target(0.63f, 0.00f, 0.1f,  4.71f, CtrlMode::OPEN_LOOP);        Set_Step_Act(1); return true;
                default: return false;
            }
        ...
        case ARM_TASK::PICK_DOWN_KFS_1_step2:
            switch (seq_idx)
            {
                ...
                case 2: Set_Ctrl_Mode(SpeedMode::NORMAL); Set_Step_Delay(100);          Set_Step_Target(0.63f, 0.00f, 0.25f, 4.71f, CtrlMode::OPEN_LOOP);        Set_Step_Act(1); return true;
                ...
                case 9: Set_Ctrl_Mode(SpeedMode::SLOW);   Set_Step_Delay(0);          Set_Step_Target(0.03f, 0.00f, 0.2f,  0.1f,  CtrlMode::Y_LOCK);           Set_Step_Act(1); return true;
        ...
        case ARM_TASK::PICK_DOWN_KFS_3_step2:
            switch (seq_idx)
            {
				...
				case 3: Set_Ctrl_Mode(SpeedMode::SLOW); Set_Step_Delay(0);        Set_Step_Target(0.20f, 0.00f, 0.40f, 2.0f, CtrlMode::Check);        Set_Step_Act(1); return true;
