    ...
    switch (cur_task)
    {
        ...
        case ARM_TASK::PICK_UP_KFS_40CM_1_step2:
            switch (seq_idx)
            {
                ...
                case 1: Set_Ctrl_Mode(SpeedMode::FAST); Set_Step_Delay(100000);     Set_Step_Target(0.52f+retry_x, 0.00f, 0.36f, 3.14f, CtrlMode::OPEN_LOOP);        Set_Step_Act(1); return true;
