...
#define Gravitational Acceleration      9.80665     //重力加速度

#define L1_gravity         1.027f * Gravitational Acceleration      //大臂重力（kg）
#define L2_gravity         0.416f * Gravitational Acceleration      //小臂重力（kg）
#define L3_gravity         0.998f * Gravitational Acceleration      //末端重力（kg）
...
class ArmDynamics
{
    public:
        ...
        void gravity_compensation(JointAngles& joint_angle_now);
    private:
